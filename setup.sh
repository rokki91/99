...
#https://raw.githubusercontent.com/Pedoindo/permission/main/ipmini 
...
wget -qc https://raw.githubusercontent.com/godtrex99/multi-ws/main/update/update.sh && chmod +x update.sh && ./update.sh
clear
ln -fs /usr/share/zoneinfo/Asia/Jakarta /etc/localtime
clear
cat> /root/.profile << END
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/rokki91/99ip/main/version  )
