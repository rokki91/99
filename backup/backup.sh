...
itoken=$(curl -sS https://raw.githubusercontent.com/rokki91/99ip/main/asi)

MYIP=$(curl -sS ipv4.icanhazip.com)
NameUser=$(curl -sS https://raw.githubusercontent.com/rokki91/99ip/main/ipmini | grep $MYIP | awk '{print $2}')
